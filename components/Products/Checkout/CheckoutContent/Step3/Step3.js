  ...
  return (
    <StyledStep3>
      <Checkbox
        ...
        padding="1.5rem"
        onClick={() => {
          orderInfoCtx.setPayment(1);
          setAllowed(true);
        }}
        className={orderInfoCtx.payment === 1 ? "active" : undefined}
      />
      <Checkbox
        ...
        padding="1.5rem"
        onClick={() => {
          orderInfoCtx.setPayment(2);
          setAllowed(true);
        }}
        className={orderInfoCtx.payment === 2 ? "active" : undefined}
      />
      <Checkbox
        ...
        padding="1.5rem"
        onClick={() => {
          orderInfoCtx.setPayment(3);
          setAllowed(true);
        }}
        className={orderInfoCtx.payment === 3 ? "active" : undefined}
      />
    </StyledStep3>
  );
};
